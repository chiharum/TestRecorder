...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database){
        ...
        database.execSQL("create table " + ContentsTableName + " (" + Table_id + " integer primary key autoincrement not null, " + Table_bookName + " string not null, " + ContentsTable_timesChallenged + " integer not null, " + ContentsTable_timesCorrect + " integer not null)");
    }
